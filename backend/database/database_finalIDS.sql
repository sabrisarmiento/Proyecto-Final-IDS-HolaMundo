...
VALUES (2,
        3,
        'Parcial re complicado',
        'Preparense para el examen de mañana va a estar re complicado')

SELECT * FROM cursos;

INSERT INTO cursos (id_materia, catedra, id_profesor, cuatrimestre, anio, slack_url, youtube_url)
VALUES (1, 'Educamus', 2, 'Primer cuatrimestre', 2026, 'ipcprueba.slack.com', 'https://www.youtube.com/@educamusonline209')